...
namespace RealEstate_Dapper_UI.Controllers
{
    public class StatisticsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var responseMessage = await client.GetAsync("https://localhost:44373/api/Statistics/ActiveCategoryCount");
            ...
            var responseMessage3 = await client3.GetAsync("https://localhost:44373/api/Statistics/ApartmentCount");
